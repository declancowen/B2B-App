...
export default function ApprovedBidPage() {
  ...
  // Actual amortization schedule data for R5M, 12 months, 14.00% APR (Interest-only structure)
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-10">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-gray-900">R5,000,000</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-medium text-gray-900">Lender</h4>
                              ...
                              <p className="text-xl font-bold text-gray-900">ABSA Bank</p>
          ...
          <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="pt-1">
                  <p className="text-base font-semibold text-black">Bid Review</p>
