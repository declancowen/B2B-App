    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-64 bg-gray-50 border-r border-gray-200">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <div 
              onClick={() => router.push('/borrow/company-dashboard')}
              className="flex items-center px-3 py-2 text-gray-600 hover:bg-gray-100 rounded-md cursor-pointer"
            >
      ...
      <div className="flex-1 px-24 py-8">
        ...
        <div className="mb-10">
          ...
          <div 
            onClick={() => router.push('/borrow/active-loan')}
        ...
        <div className="mb-10">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Completed Loans</h2>
          <div className="space-y-4">
            {/* Trade Finance Loan */}
          <div 
            onClick={() => router.push('/borrow/completed-loan')}
            className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer"
          >
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">R20,000,000</p>
                </div>
              </div>
