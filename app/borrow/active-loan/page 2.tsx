...
export default function ActiveLoanPage() {
  ...
  // Actual amortization schedule data for R2M loan
  ...
  const actualSchedule = [
    ...
    { month: 1, monthlyPayment: 348133.33, principalPaid: 337466.67, interestPaid: 10666.67, remainingBalance: 1662533.33, cumulativeInterest: 10666.67, cumulativePrincipal: 337466.67 },
    { month: 2, monthlyPayment: 348133.33, principalPaid: 339250.00, interestPaid: 8883.33, remainingBalance: 1323283.33, cumulativeInterest: 19550.00, cumulativePrincipal: 676716.67 },
    { month: 3, monthlyPayment: 348133.33, principalPaid: 341044.44, interestPaid: 7088.89, remainingBalance: 982238.89, cumulativeInterest: 26638.89, cumulativePrincipal: 1017761.11 },
    { month: 4, monthlyPayment: 348133.33, principalPaid: 342850.00, interestPaid: 5283.33, remainingBalance: 639388.89, cumulativeInterest: 31922.22, cumulativePrincipal: 1360611.11 },
    { month: 5, monthlyPayment: 348133.33, principalPaid: 344666.67, interestPaid: 3466.67, remainingBalance: 294722.22, cumulativeInterest: 35388.89, cumulativePrincipal: 1705277.78 },
    { month: 6, monthlyPayment: 348133.33, principalPaid: 294722.22, interestPaid: 1577.78, remainingBalance: 0, cumulativeInterest: 36966.67, cumulativePrincipal: 2000000 }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 mt-4">
          <p className="text-sm text-gray-500">
            ...
            <span className="text-gray-900">Active Loan Details</span>
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">Your loan is currently active and disbursed</p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">LN-2023-00124</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500 mb-1">Date Disbursed</p>
                <p className="text-lg font-semibold text-gray-900">November 1, 2023</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Rest of the component continues with billing schedule, payment details, etc. */}
