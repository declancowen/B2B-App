  ...
  return (
    <div className="min-h-screen bg-white px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900 mb-4">Loan Approved</h1>
          <p className="text-gray-600">
            Your loan has been approved. The borrower will now proceed to sign the contract.
          </p>
        </div>
        ...
        <div className="mb-10">
          <div className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div>
              <h3 className="text-base font-semibold text-gray-900">Loan Approved</h3>
              <p className="text-sm text-gray-500">Awaiting contract signature</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="flex items-start p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div>
              <h3 className="text-base font-semibold text-gray-900 mb-1">Contract Signing</h3>
              <p className="text-sm text-gray-500">The borrower will sign the contract to finalize the loan agreement.</p>
            </div>
          </div>
        </div>
