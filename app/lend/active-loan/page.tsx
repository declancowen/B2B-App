...
export default function ActiveLoanPage() {
  ...
  const pieData = [
    { name: 'Principal Amount', value: loanAmount * 0.98, color: '#d1d5db' }, // Net of fees
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-amber-800">
                      ...
                      but the full principal amount of R{loanAmount.toLocaleString('en-US', { maximumFractionDigits: 0 })} plus interest is being repaid to you as the lender.
                    </p>
                  </div>
                </div>
              </div>
